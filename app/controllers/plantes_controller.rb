class PlantesController < ApplicationController
  ...
  private
    ...
    def plante_params
      params.require(:plante).permit(:nom, :image_url, :arrosage_hiver, :arrosage_printemps_ete, :origine, :rempotage, :maladie, :categorie, :temperature, :substrat, :taille, :bouturage)
    end
end
